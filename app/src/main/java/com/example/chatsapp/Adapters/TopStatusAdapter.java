...
public class TopStatusAdapter extends RecyclerView.Adapter<TopStatusAdapter.TopStatusViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TopStatusViewHolder holder, int position) {
        ...
        Glide.with(context).load(lastStatus.getImageUrl()).into(holder.binding.image);  // upload image avatar on stories

        holder.binding.circularStatusView.setPortionsCount(userStatus.getStatuses().size()); // count image uploaded
