        ...
        binding.btnSetupProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedImage != null){
                            ...
                            if (task.isSuccessful()){
                                reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        String userProfileImage = uri.toString();

                                        User user = new User(userId, userName, userPhoneNumber, userProfileImage);
                    ...
                    User user = new User(userId, name, userPhoneNumber, "No Image");
                    database.getReference()
                            .child("users")
                            .child(userId)
                            .setValue(user)
